angular.module("nutritionApp").controller("nutritionController", [
    "$http",
    "$mdEditDialog",
    "$q",
    "$timeout",
    "$scope",
    function ($http, $mdEditDialog, $q, $timeout, $scope) {
        "use strict";
        ...
        // To test automatic selection via simple compare:
        // $scope.selected = ["109c7a1a9d33b664f2ee7852", "109c7a1a9d33b664f2ee7853"];
        ...
        $http.get("desserts.json").then(function (desserts) {
            ...
            // To test normal selection using objects
            // $scope.selected.push($scope.desserts.data[0]);
